...
function TVSHow() {
    ...
    useEffect(() => {
        ...
        fetch(
            `https://api.themoviedb.org/3/discover/tv?api_key=d1726c3024603cccff7d39494637902d&with_genres=${cate}&page=${page}`,
        )
            .then((res) => res.json())
            .then((data) => {
    ...
    useEffect(() => {
        fetch(
            `https://api.themoviedb.org/3/discover/tv?api_key=d1726c3024603cccff7d39494637902d`,
        )
            .then((res) => res.json())
            .then((data) => {
    ...
    useEffect(() => {
        ...
        fetch(
            `https://api.themoviedb.org/3/discover/tv?api_key=d1726c3024603cccff7d39494637902d&with_genres=${cate}`,
        )
            .then((res) => res.json())
            .then((data) => {
                setTotalPage(data.total_pages);
